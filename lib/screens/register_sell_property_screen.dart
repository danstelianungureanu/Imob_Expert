...
class RegisterSellPropertyScreen extends StatefulWidget {
  final String propertyType;
  final String phoneNumber;

  const RegisterSellPropertyScreen({
    super.key,
  ...
  @override
  _RegisterSellPropertyScreenState createState() =>
      _RegisterSellPropertyScreenState();
}

class _RegisterSellPropertyScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Adaugă anunț de vânzare'),
      ),
      body: Padding(
